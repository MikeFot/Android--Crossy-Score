...
import com.michaelfotiadis.crossyscore.core.BuildConfig;
...
public final class SdkLog {
    ...
    private static void dInternal(final String message) {
        if (BuildConfig.DEBUG || CrossyCore.isDebugEnabled()) {
    ...
    private static Set<String> getEscapedClassNames() {
        ...
        set.add(DbLog.class.getName());
        set.add(Log.class.getName());
        set.add(SdkLog.class.getName());
