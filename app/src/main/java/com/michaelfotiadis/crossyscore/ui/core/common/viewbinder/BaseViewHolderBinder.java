 ...
 *
 */
public abstract class BaseViewHolderBinder<VH extends BaseViewHolder, D extends AppModel> {

    private final Context mContext;
    private final IntentDispatcher mIntentDispatcher;

    protected BaseViewHolderBinder(final Context context, final IntentDispatcher intentDispatcher) {
